...
var paper = function (self, undefined) {
    ...
    var Project = PaperScopeItem.extend({
        ...
        _insertItem: function (index, item, _created) {
            item =
                ...
                (this._activeLayer || this._insertItem(undefined, new Layer(Item.NO_INSERT), true)).insertChild(index, item);
                ...
                transform: function (matrix, _applyRecursively, _setApplyMatrix) {
                    var _matrix = this._matrix,
                        ...
                        applyMatrix =
                            ...
                            (this._applyMatrix &&
                                (transformMatrix || !_matrix.isIdentity() || (_applyRecursively && this._children)));
    ...
    var Group = Item.extend({
        ...
        _hitTestChildren: function _hitTestChildren(point, options, viewMatrix) {
            var clipItem = this._getClipItem();
            return (
                (!clipItem || clipItem.contains(point)) && _hitTestChildren.base.call(this, point, options, viewMatrix, clipItem)
            );
        },
    ...
    var Shape = Item.extend(
        {
            ...
            _getBounds: function (matrix, options) {
                ...
                return strokeWidth
                    ? rect.expand(Path._getStrokePadding(strokeWidth, this._getStrokeMatrix(matrix, options)))
                    : rect;
            },
        },
        new (function () {
            ...
            return {
                _contains: function _contains(point) {
                    if (this._type === "rectangle") {
                        ...
                        return center
                            ? point.subtract(center.point).divide(this._radius).getLength() <= 1
            ...
            function getOverlaps(v1, v2) {
                ...
                for (var i = 0; i < 4 && pairs.length < 2; i++) {
                    ...
                    if (t2 != null) {
                        ...
                        if (
                            !pairs.length ||
                            (abs(pair[0] - pairs[0][0]) > timeEpsilon && abs(pair[1] - pairs[0][1]) > timeEpsilon)
                        ) {
                            pairs.push(pair);
                        }
                    }
                    ...
                    return !!(
                        ...
                        (!operator ||
                            (operator[(winding = seg._winding || {}).winding] &&
                                !(operator.unite && winding.winding === 2 && winding.windingL && winding.windingR)))
                    );
                }
                        ...
                        while (inter && inter !== end) {
                            ...
                            if (path) {
                                ...
                                if (
                                    ...
                                    (isStart(other) ||
                                        isStart(next) ||
                                        (next && isValid(other) && (isValid(next) || (nextInter && isValid(nextInter._segment)))))
                                ) {
    ...
    var Style = Base.extend(
        ...
        })(),
        {
            ...
            equals: function (style) {
                ...
                return (
                    style === this ||
                    (style && this._class === style._class && compare(this, style) && compare(style, this, true)) ||
                    false
                );
            },
            ...
            if (el) {
                for (var type in events) {
                    ...
                    for (var i = 0, l = parts.length; i < l; i++) {
                        var name = parts[i];
                        var options =
                            el === document && (name === "touchstart" || name === "touchmove") ? { passive: false } : false;
    ...
    var View = Base.extend(
        ...
        new (function () {
            ...
            function emitMouseEvents(view, hitItem, type, event, point, prevPoint) {
                ...
                return (
                    (dragItem && emitMouseEvent(dragItem, null, type, event, point, prevPoint)) ||
                    (hitItem &&
                        hitItem !== dragItem &&
    ...
    new (function () {
        ...
        function getValue(node, name, isString, allowNull, allowPercent, defaultValue) {
            ...
            return /%\s*$/.test(value)
                ? (res / 100) * (allowPercent ? 1 : rootSize[/x|^width/.test(name) ? "width" : "height"])
                : res;
        }

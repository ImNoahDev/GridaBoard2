...
class PaperInfo {
  ...
  /**
   * @public
   * @param {{section?:number, owner:number, book:number, page:number, x?:number, y?:number}} coordInfo
   */
  isPUI = (coordInfo) => {
   ...
   * @param {{section?:number, owner:number, book:number, page?:number}} pageInfo
   */
  getPaperSize = (pageInfo) => {
    const { section, owner, book, page } = pageInfo;
    let size = {};
    let paper_info = this.getPaperInfo({ owner, book });
   ...
   * @public
   * @param {{section:number, owner:number, book:number, page:number, dpi:number}} pageDpiInfo
   */
  getPaperSize_px = (pageDpiInfo) => {
    const { section, owner, book, page, dpi } = pageDpiInfo;

    let size = this.getPaperSize({ owner, book });

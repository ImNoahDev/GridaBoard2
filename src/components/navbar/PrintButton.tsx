...
class printFunction extends React.Component<Props> {
  startPrint = () => {
    const elem = document.getElementById(this.props.targetId);
  ...
  render() {
    return (
      ...
      <React.Fragment>
        <button id="btn_print_pdf" type="button" disabled className="btn btn-neo " onClick={this.startPrint}>
